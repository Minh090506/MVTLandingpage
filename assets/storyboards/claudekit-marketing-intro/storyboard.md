# Storyboard: ClaudeKit Marketing - Top 4 Features
...
A 32-second feature-focused intro video showcasing ClaudeKit Marketing's 4 killer features. Uses "Colored Sketch + Handwriting Annotations" art style for a dynamic, educational storyboard feel.
...
ClaudeKit Marketing replaces 5-10 separate tools with one unified AI marketing system powered by 27 specialized agents.
...
- **VO:** "ClaudeKit Marketing gives you 27 specialized AI agents. Copywriter. SEO. Email. Social. All working as one team."
...
**Prompt:** Colored pencil sketch storyboard style, split composition: left side shows crossed-out pile of app icons from scene 1 (red X marks), right side shows clean single laptop with ClaudeKit logo sketch, large handwritten arrow from chaos to simplicity, annotation "before / after" at top, warm paper texture, teal and purple accents, 16:9 aspect ratio
...
- **VO:** "Stop tool-hopping. Start marketing smarter. ClaudeKit Marketing - your AI marketing team awaits."
...
- Scene 4 (0:28): "claudekit.dev" URL, "Try Free" button
...
- Storyboard Format Guide: `~/.claude/skills/video-production/references/storyboard-format.md`
- Script Templates: `~/.claude/skills/video-production/references/script-templates.md`
- AI Multimodal (Imagen 4): `~/.claude/skills/ai-multimodal/skill.md`
