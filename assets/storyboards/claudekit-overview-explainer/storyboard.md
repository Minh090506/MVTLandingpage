# Storyboard: ClaudeKit Overview Explainer
...
A 30-second explainer video introducing ClaudeKit - the AI-powered marketing automation toolkit. Structure: Hook > Problem > Solution > CTA.
...
ClaudeKit turns Claude Code into a complete marketing automation platform with specialized AI agents working together.
...
- **VO:** "What if your marketing could run itself? Meet ClaudeKit."
...
- **VO:** "ClaudeKit deploys specialized AI agents that work together - content creation, SEO, email campaigns, social media, all orchestrated automatically."
...
**Prompt:** Split composition showing modern laptop on left with ClaudeKit terminal interface, and abstract flowing data visualization on right representing automation, purple and blue gradient background, clean professional aesthetic, photorealistic, 4k, 16:9 aspect ratio, cinematic lighting, space for text overlay at bottom third
...
- **VO:** "Start automating your marketing today. ClaudeKit - your AI marketing team."
...
- Scene 1: "ClaudeKit" logo fade in at 0:05
- Scene 4: "claudekit.dev" URL at 0:25, "Try Free" button at 0:27
...
- Quality Review Workflow: `../../.claude/skills/video-production/references/quality-review-workflow.md`
- Veo Prompt Guide: `../../.claude/skills/video-production/references/veo-prompt-guide.md`
- Vision Analysis: `../../.claude/skills/ai-multimodal/references/vision-understanding.md`
